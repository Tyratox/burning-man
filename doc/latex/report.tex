...
For the sake of simplicity this chapter is split into the definition of the environment model and the agent model, since the environment model is to some extend independent of the agents model. 
