...
\begin{itemize}
    ...
    \begin{figure}[H]
		\centering
		\includegraphics[width=0.25\linewidth]{assets/without-navmesh}\\
		An agent stuck within obstacles as the direct force\\
		in the direction of the sign doensn't help
	\end{figure}
